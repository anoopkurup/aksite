  ...
  return (
    <div className="bg-background">
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-16 items-center">
                  ...
                  {heroMedia ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center space-y-3">
                        <div className="w-20 h-20 md:w-16 md:h-16 bg-solarized-base03/20 rounded-full flex items-center justify-center mx-auto">
            ...
            <div className="order-last md:order-1">
              <Badge className="mb-6 bg-[#8fb4ff] text-solarized-base0 border-[#8fb4ff] hover:bg-[#8fb4ff]/90">
              ...
              <div className="mt-8 flex items-center space-x-4">
                <div className="flex -space-x-2">
                  <Avatar className="border-2 border-white">
                    <AvatarFallback className="bg-[#8fb4ff] text-solarized-base0">SC</AvatarFallback>
                  </Avatar>
                  <Avatar className="border-2 border-white">
                    <AvatarFallback className="bg-[#8fb4ff] text-solarized-base0">MR</AvatarFallback>
                  </Avatar>
                  <Avatar className="border-2 border-white">
                    <AvatarFallback className="bg-[#8fb4ff] text-solarized-base0">DT</AvatarFallback>
                  </Avatar>
                </div>
                <div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-12 items-start">
              ...
              <div className="md:col-span-2">
                <h2 className="text-section-title font-bold text-solarized-base0 mb-6">{aboutSection.title}</h2>
                <div className="text-solarized-base1 leading-relaxed space-y-4 mb-6">
      ...
      <section className="py-16 px-6 bg-solarized-base03">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-section-title font-bold text-solarized-base0">I Work Best With</h2>
            <p className="text-xl text-solarized-base1 max-w-4xl mx-auto">
            ...
            {audienceSegments.map((segment: any, index: number) => (
              <div key={index} className="text-center">
                <div className="mb-6">
                  ...
                  <h3 className="text-xl font-bold text-solarized-base0 mb-2">{segment.title}</h3>
                  <p className="text-[#1e40af] font-semibold mb-4">{segment.subheading}</p>
                </div>
                <p className="text-solarized-base1 leading-relaxed mb-6">
                  {segment.description}
                </p>
                <div className="bg-[#f59e0b]/10 p-4 rounded-lg mb-6">
                  <p className="text-sm font-semibold text-solarized-base0">
                    Typical results: {segment.results}
                  </p>
                </div>
                <Button asChild className="w-full bg-solarized-base02 hover:bg-[#1e40af] text-white">
      ...
      <section className="py-16 px-6 bg-[#fef7ed]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-section-title font-bold text-solarized-base0">What I Offer</h2>
            <p className="text-xl text-solarized-base1">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service: any, index: number) => (
              <div key={index} className="text-center">
                ...
                <h3 className="text-subsection text-solarized-base0 mb-4">{service.title}</h3>
                <p className="text-solarized-base1 leading-relaxed mb-6">{service.description}</p>
                <Button asChild className="w-full bg-[#1e40af] hover:bg-solarized-base02 text-white">
      ...
      <section className="py-16 px-6 bg-solarized-base03">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-section-title font-bold text-solarized-base0">What Clients Say</h2>
            <p className="text-xl text-solarized-base1">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial: any, index: number) => (
              <div key={index} className="bg-[#fef7ed] p-6 rounded-lg">
                <p className="text-solarized-base1 italic leading-relaxed mb-6">
                  "{testimonial.quote}"
                </p>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-[#8fb4ff] rounded-full flex items-center justify-center text-solarized-base0 font-bold">
                    {testimonial.author.split(' ').map((n: string) => n[0]).join('')}
                  </div>
                  <div>
                    <p className="font-semibold text-solarized-base0">{testimonial.author}</p>
                    <p className="text-sm text-solarized-base1">{testimonial.role}</p>
                    <p className="text-sm text-solarized-base1">{testimonial.company}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-16 px-6 bg-[#fef7ed]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-section-title font-bold text-solarized-base0">My Approach</h2>
            <p className="text-xl text-solarized-base1">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {approachPrinciples.map((principle, index) => (
              <div key={index} className="text-center">
                ...
                <h3 className="text-xl font-bold text-solarized-base0 mb-4">{principle.title}</h3>
                <p className="text-solarized-base1 leading-relaxed">{principle.description}</p>
              </div>
            ))}
          </div>
        </div>
