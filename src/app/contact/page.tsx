...
export default function ContactPage() {
  ...
  return (
    ...
    >
      ...
      <section className="py-20 px-6 bg-[#fef7ed]">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg p-8">
              <div className="text-center">
                <div className="bg-[#FFBF00] text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Mail size={32} />
                </div>
                ...
                <a 
                  ...
                  className="inline-flex items-center justify-center bg-[#1e3a8a] hover:bg-[#1e40af] text-white px-8 py-4 rounded-lg text-lg font-semibold"
                >
                  mail@anoopkurup.com
                </a>
              </div>
                ...
                <div className="flex justify-center space-x-6">
                  {socialLinks.map((link) => (
                    <div key={link.platform} className="flex flex-col items-center">
                      <div className="bg-[#1e3a8a] p-6 rounded-lg mb-3">
                        <SocialIcon
