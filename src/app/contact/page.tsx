          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
              <div className="text-center">
                <div className="bg-cta-500 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Mail size={32} />
                </div>
                <h3 className="text-2xl font-bold text-navy-900 mb-4">Email Me Directly</h3>
                <p className="text-gray-700 mb-6">
                  The fastest way to reach me for project discussions and consultations.
                </p>
                <a
                  href="mailto:mail@anoopkurup.com"
                  className="inline-flex items-center justify-center bg-cta-500 hover:bg-cta-600 text-white px-8 py-4 rounded-lg text-lg font-semibold"
                >
                  mail@anoopkurup.com
                </a>
              </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-navy-900 mb-4">Connect on Social</h3>
                <p className="text-gray-700 mb-6">
