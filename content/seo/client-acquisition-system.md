...
![The weekly rhythm](/images/pages/client-acquisition-system-rhythm.webp)
...
Which is why the honest first step is a diagnosis rather than a purchase. If you want the weakest part of your system located and named, [get in touch](/contact) and tell me what you are seeing. I will tell you honestly where I would start.

From there, the path I take with firms is deliberately incremental: first the [offer](/blog/how-to-productize-your-service), because everything points at it; then the [break from referral dependence](/blog/stop-relying-on-referrals) via a named list and warm-path work; then [lead generation](/blog/lead-generation-for-service-business) as a weekly rhythm; then extracting the sale from [the founder's head](/blog/founder-led-sales-trap) so the machine can eventually run without its inventor. For firms that want this installed rather than described, that is the consulting work I do, working alongside you on real prospects. But the system above is not a secret, and a determined founder can build a good deal of it alone.

If you run an advisory or consulting practice, where buyers judge the people because they cannot judge the work in advance, the same system is applied to your kind of firm in [marketing for professional services firms](/marketing-for-professional-services).
