...
![Trust, timing and framing rebuilt as three deliberate blocks](/images/blog/stop-relying-on-referrals/inline-2.webp)
...
These four parts connect into something larger, and I have laid out the whole of it in one place: the [client acquisition system](/client-acquisition-system) as I build it with firms. But you do not need the whole machine on day one. You need the parts above, running weekly, for long enough to compound.
