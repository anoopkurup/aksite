---
hero_image: "/images/blog/scale-beyond-the-founder/hero.webp"
title: 'How to Scale a Consulting Business Beyond You'
seo_title: How to Scale a Consulting Business
date: '2026-08-17'
description: >-
  Growth stalls when everything runs through the founder. Here is how to scale
  a consulting business by removing yourself from the parts that don't need
  you.
tags:
- Scaling
- Business Model
...
A defined offer makes this far easier, which is why productising and scaling travel together. A bespoke, it-depends engagement can only be delivered by the person whose judgement shapes it, while a [productised service](/blog/how-to-productize-your-service) with a fixed scope and outcome can be taught. If your work resists systemising, that usually means the offer is still too shapeless to scale.
...
![Project spikes versus a steady retainer floor](/images/blog/scale-beyond-the-founder/inline-2.webp)
...
How dependent is the business on you, really? [Get in touch](/contact) and tell me what a two-week holiday would break. I'll tell you honestly which dependency to remove first.
