...
Here is the part that quietly drains the business: nobody pays you more for taking all of this on. The work that used to be done by the client is now unpaid labour buried inside your delivery: scoping the problem, making the judgement calls, owning the result. A piece of work that took forty hours for a large client takes sixty for a small one, because twenty of those hours used to be done by someone on the client's side. You end up doing considerably more for a smaller fee.
...
Most service firms that struggle down-market are not underpriced. They are being bought as a brand while still operating as a cog. Close that gap by owning the brief and productising the scope, and smaller clients stop being the accounts that quietly cost you money.
