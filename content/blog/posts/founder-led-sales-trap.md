...
![Three bodies of knowledge locked in one vault](/images/blog/founder-led-sales-trap/inline-1.webp)
...
![The sale, documented: from one head to four pages](/images/blog/founder-led-sales-trap/inline-2.webp)
...
Write it as four short documents: the qualification checklist, the questions and your best answers, the stories with their numbers, and the deal rules, covering what you flex and what you never flex. Half a day of writing, all told. This becomes the firm's sales playbook, and it changes what is possible next. One thing that makes every one of these documents dramatically shorter, incidentally, is a [productised offer](/blog/how-to-productize-your-service): a sale with a defined scope and price needs far less judgement per deal, which is precisely why packaged offers are easier to hand over.
