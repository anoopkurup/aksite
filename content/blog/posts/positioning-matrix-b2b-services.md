...
![Positioning that names a problem versus positioning that names a profile](/images/blog/positioning-matrix-b2b-services/inline-1.webp)
...
The first is **how specifically the problem is named**. Not how specific your service is — how specific the *problem* is, in the client's own language, before you arrive.
...
![Looking backwards at completed work to find the problem worth owning](/images/blog/positioning-matrix-b2b-services/inline-2.webp)
...
And which ones had somebody's job attached to them? Not the company's fortunes in the abstract — an actual person whose standing depended on this being fixed. That is where intensity lives.
